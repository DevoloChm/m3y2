...
btn_generate.grid(row=1, column=1, padx=10)

settings_frame_left = CTkFrame(window, width=250)
...
count_password_chars_slider = CTkSlider(settings_frame_right, from_=4, to=64, orientation='vertical',
